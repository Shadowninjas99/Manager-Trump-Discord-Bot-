...
class Info(commands.Cog):
    ...
    async def _help(self, ctx):
        ...
        embedvar.add_field(name='$gif', value='To share gif', inline=False)
        embedvar.add_field(name='$poll', value='To start a poll', inline=False)
        embedvar.add_field(name='$tictactoe', value='To play tictactoe with a friend', inline=False)
        embedvar.add_field(name='$place', value='To place your mark in Tictactoe', inline=False)
